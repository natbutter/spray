...
- [index.html](file:///usr/local/google/home/butterworthnat/HACK/spray/index.html): The main web page, UI layout, and event handlers.
- [js/spray-reader.js](file:///usr/local/google/home/butterworthnat/HACK/spray/js/spray-reader.js): Contains the `SprayReader` class which manages the text preprocessing, timers, speech synthesis integration, text highlighting, and the ORP centering algorithm.
- [css/spray-style.css](file:///usr/local/google/home/butterworthnat/HACK/spray/css/spray-style.css): Styles for the RSVP display, pivot character coloring (red), and the synchronized scroll/highlight overlay.
- [css/site-style.css](file:///usr/local/google/home/butterworthnat/HACK/spray/css/site-style.css): Basic layout and typography styling for the demo page.
